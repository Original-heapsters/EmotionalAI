...
var source, sourceJs;
var analyser;
var url = 'data/CHON-Story.mp3';
var array = new Array();
var boost = 0;
var average = 0;
var maxAudioValue;
var oldMaxFreqBandName;
var currentMaxFreqBandName;
var MaxAudioGreaterThan252;
			...
			*/
			sourceJs.onaudioprocess = function(e) { //javascript node is called
				...
				*/
				...
				//var arr = [averageFreqBand1, averageFreqBand2, averageFreqBand3, averageFreqBand4, averageFreqBand5to7];
				...
				*/
				...
				getMaxAudioValue(); //returns the value of the highest band represented

				var MaxAudioGreaterThan252= isMaxAudioValueGreaterThan252();

				currentMaxFreqBandName = maxAudioWhichHighestFreqBand(); //returns the name of the frequencyBand such as "averageFreqBand2"
				
				oldMaxFreqBandName = currentMaxFreqBandName;

				hasHighestFrequencyBandChanged();
				//current highest 
				//find out when the highest freq band changes 
				//find out also when it is over 250
			...
			//my assumption is that it provides information of artist, album and song with link/source to where the music was found as credit
				.fadeOut('normal', function() {
					$(this).html('<div id="artist"><a class="name" href="https://chonofficial.bandcamp.com/" target="_blank">CHON</a><br /><a class="song" href="https://www.youtube.com/watch?v=EcGFm2Bf20c" target="_blank">Story</a><br /></div><div><img src="data/chon-story.jpg" width="58" /></div>');
				})
				.fadeIn();
...
function isMaxAudioValueGreaterThan252(){
	//test to see how often the dance move will be changed
	if (maxAudioValue>252){ //set to 252 since it is one of the higher numbers
		console.log("************************** MAX AUDIO VAL > 252 **************************");
		//head bang
		return true;
	}
...
//finds out which was the highest averaged frequency band value and returns that variable name
function maxAudioWhichHighestFreqBand(){//isMaxAudioValueGreaterThan252

	if (maxAudioValue == averageFreqBand1){
		//console.log(maxAudioValue + "==" + averageFreqBand1 + "?"); //checks if the value are the same
		//console.log("averageFreqBand1");
		return "averageFreqBand1";
	}else if (maxAudioValue == averageFreqBand2){
		//console.log(maxAudioValue + "==" + averageFreqBand2 + "?");
		//console.log("averageFreqBand2");
		return "averageFreqBand2";
	}else if (maxAudioValue == averageFreqBand3){
		//console.log(maxAudioValue + "==" + averageFreqBand3 + "?");
		//console.log("averageFreqBand3");
		return "averageFreqBand3";
	}else if (maxAudioValue == averageFreqBand4){
		//console.log(maxAudioValue + "==" + averageFreqBand4 + "?");
		//console.log("averageFreqBand4");
		return "averageFreqBand4";
	}else if (maxAudioValue == averageFreqBand5to7){
		//console.log(maxAudioValue + "==" + averageFreqBand5to7 + "?");
		//console.log("averageFreqBand5to7");
		return "averageFreqBand5to7";
	}else {
		//console.log("error");
		return;
	} 
...
//http://stackoverflow.com/questions/3635924/how-can-i-make-a-program-wait-for-a-variable-change-in-javascript
//find if and when the maxHighestFreqBand Name has changed
function hasHighestFrequencyBandChanged(){
	if (currentMaxFreqBandName===oldMaxFreqBandName){
		setTimeout(hasHighestFrequencyBandChanged, 50);//wait 50 millisecnds then recheck
		//console.log("setTimeout");
        return;
	}
	oldMaxFreqBandName=currentMaxFreqBandName;
	console.log("oldMaxFreqBandName was: " + oldMaxFreqBandName);
	console.log("currentMaxFreqBandName has Switched to: " + currentMaxFreqBandName);
}
